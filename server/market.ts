...
const statementMetrics: Record<FinancialStatementKind, StatementMetric[]> = {
  income: [
    ...
    { key: "costOfRevenue", label: "Satışların Maliyeti", providerKey: "annualCostOfRevenue" },
    { key: "grossProfit", label: "Brüt Kâr", providerKey: "annualGrossProfit" },
    { key: "operatingExpense", label: "Faaliyet Giderleri", providerKey: "annualOperatingExpense" },
    { key: "operatingIncome", label: "Faaliyet Kârı", providerKey: "annualOperatingIncome" },
    { key: "pretaxIncome", label: "Vergi Öncesi Kâr", providerKey: "annualPretaxIncome" },
    { key: "taxProvision", label: "Vergi Karşılığı", providerKey: "annualTaxProvision" },
  ...
  balance: [
    ...
    { key: "receivables", label: "Ticari Alacaklar", providerKey: "annualAccountsReceivable" },
    { key: "inventory", label: "Stoklar", providerKey: "annualInventory" },
    { key: "currentAssets", label: "Dönen Varlıklar", providerKey: "annualCurrentAssets" },
    { key: "assets", label: "Toplam Varlıklar", providerKey: "annualTotalAssets" },
    { key: "currentLiabilities", label: "Kısa Vadeli Yükümlülükler", providerKey: "annualCurrentLiabilities" },
    { key: "longTermDebt", label: "Uzun Vadeli Borç", providerKey: "annualLongTermDebt" },
  ...
  cashflow: [
    ...
    { key: "investingCashFlow", label: "Yatırım Faaliyetleri Nakit Akışı", providerKey: "annualInvestingCashFlow" },
    { key: "financingCashFlow", label: "Finansman Faaliyetleri Nakit Akışı", providerKey: "annualFinancingCashFlow" },
    { key: "debtIssued", label: "Borçlanma Girişi", providerKey: "annualIssuanceOfDebt" },
    { key: "debtRepaid", label: "Borç Geri Ödemesi", providerKey: "annualRepaymentOfDebt" },
    { key: "freeCashFlow", label: "Serbest Nakit Akışı", providerKey: "annualFreeCashFlow" },
    { key: "endCash", label: "Dönem Sonu Nakit", providerKey: "annualEndCashPosition" },
  ],
};
