...
- [x] CV indirme tamamlandıktan sonra adımlı seçim akışını başlangıç durumuna otomatik sıfırla. Hazırlanma durumundan sonra dosya indirilir ve seçim akışı yeniden tek CTA’ya döner.
- [x] Piyasa Özeti alt satırlarının grid/hizalama sorununu referans düzeniyle uyumlu biçimde düzelt. Alt üç hücre eşit genişlik, tutarlı bordür ve tek satır değer davranışıyla hizalandı.
- [x] Income, Balance ve Cash Flow ana grafiklerini Fiyat grafiği kadar etkileşimli hover/tooltip davranışı olan mali trend görünümlerine dönüştür. Yıllık çubuk grafikte dönem hover’ı seçili kalem değerlerini ve para birimini gösteriyor; kaynak farklı para biriminde seri bazlı normalizasyon açıklanıyor.
- [x] Sağ Finansal Analiz dock’unu panel kolonu boyunca uzat; Total Assets, Total Debt, Equity, Cash Flow ve seçili mali görünümün temel kalemleriyle doldur. Gelir Kalitesi, Bilanço Gücü ve Nakit Akışı başlıkları altında tüm Yahoo yıllık kalemleri uzun dock’ta gösteriliyor.
- [x] Türkçe/İngilizce dil anahtarını ekle ve tüm kullanıcı arayüzü metinlerini iki dil için eksiksiz yerelleştir. Sabit başlıklar, modüller, profil, CV, araştırma, bağlantı, form alanları, bildirim/keşif etiketleri iki dilde işlendi.
...
- [x] Masaüstü terminalde sol dock, ana çalışma alanı ve sağ analiz dock’unun alt bitişlerini dengeli bir yüzeyde hizala. Pano üç kolonu tek minimum ekran yüksekliğinde hizalandı; grafik ve Piyasa Özeti aynı satır/yükseklikte yerleşti.
- [x] TR/EN anahtarını bildirim ve bağlantı simgeleriyle çakışmayacak ayrı, görünür bir konuma taşı. Masaüstünde üst araç şeridine, mobilde üst kromun ayrı sağ alanına taşındı.
- [x] Pano görünümünü yalnızca piyasa terminali, izleme, grafik ve finansal analiz panellerine odaklı ana sayfa olarak sadeleştir. Profil ve eğitim/araştırma kartları Pano’dan çıkarıldı.
- [x] Profil görünümünü Onur İnal hakkında özet, eğitim, proje, yetkinlik, CV ve iletişim erişimi bulunan kişisel/resume sayfasına dönüştür. Kişisel özet/CV yanında eğitim, araştırma pratiği, iş birliği, ödül, proje ve araçlar sayfaya eklendi.
- [x] Raporlar görünümünü yayınlanan araştırmaları listeleme, filtreleme, öne çıkarma ve dosya incelemeye odaklı bağımsız kütüphane sayfasına genişlet. Sol/sağ dock kaldırılarak PDF, kategori ve inceleme akışına odaklanan tam genişlikli kütüphane korundu.
- [x] Bağlantı görünümünü mesaj taslağı, doğrudan iletişim kanalları, yanıt beklentisi ve iş birliği konularını içeren bağımsız iletişim sayfasına dönüştür. Sol/sağ dock kaldırılarak form, kanallar, gizlilik ve iş birliği blokları tam genişlikte gösterildi.
- [x] Yeni düzeni, modül sayfalarını, dil anahtarını ve mobil akışı görsel olarak doğrula; testleri ve üretim derlemesini çalıştır. Masaüstü/mobil ekran denetimleri, 11 birim test, tür denetimi ve üretim derlemesi başarılı.
- [x] Bu bilgi mimarisi ve düzen güncellemesini yeni checkpoint olarak kaydet ve teslim et. Doğrulanmış v1.2 sürümü checkpoint için hazırlandı.
- [x] Pano görünümüne Onur İnal profilini ve eğitim/araştırma özetini çok panelli terminal kompozisyonu içinde geri ekle. Profil, Grafik, Piyasa Özeti ve Eğitim & Araştırma panelleri tekrar Pano’da bulunuyor.
- [x] Pano’daki grafik, piyasa özeti, profil/araştırma ve sağ finansal analiz bloklarının görsel hiyerarşisini dengeli çok panelli düzenle yeniden kur. Profil üst bağlamı kuruyor; grafik/özet yan yana araştırma yüzeyini, eğitim paneli kapanış bağlamını oluşturuyor.
- [x] Profil sayfasını özgeçmiş, akademik yolculuk, yetkinlik haritası, proje dosyası, CV akışı ve iletişim panellerinden oluşan yaratıcı terminal yüzeyine genişlet. İki terminal çerçevesinde profil/CV ve Kişisel Dosya panelleri oluşturuldu.
- [x] Raporlar sayfasını araştırma rafı, yayın takvimi, metodoloji kartları, konu haritası ve PDF inceleme paneli bulunan çok panelli kütüphaneye dönüştür. Mevcut PDF kütüphanesine Araştırma Haritası, yayın protokolü ve kütüphane ritmi panelleri eklendi.
...
- [x] Onur İnal Profil panelini içindeki özet, etiket ve CV yüzeyini kesmeden kapsayacak doğal genişlik/yüksekliğe getir. Üst satır 500px’e alındı; profilin özet ve CV CTA alanı tek panelde tam görünür.
- [x] Yıllık Finansallar panelini ana Pano orta gridinden çıkar ve sağdaki Finansal Analiz dock’unun doğrudan altına dikey ikinci analiz yüzeyi olarak taşı. FUNDAMENTALS paneli sağ dock’ta FİNANSAL ANALİZ’in hemen altında yer alıyor.
